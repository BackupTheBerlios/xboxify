#-----------------------------------------------------------------------------
# Name:        DirectoryWalker.py                                             
# Purpose:     Walks a directory (including all sub-dirs) and returns all     
#              files and directories found                                    
#                                                                             
# Author:      Alexander Skwar <XboxIfy@message-center.info>                  
#                                                                             
# Created:     2003/17/03                                                     
# RCS-ID:      $Id: DirectoryWalker.py,v 1.1 2003/03/17 15:18:03 askwar Exp $
# Copyright:   (c) 2003                                                       
# Licence:     GPL                                                            
#-----------------------------------------------------------------------------
