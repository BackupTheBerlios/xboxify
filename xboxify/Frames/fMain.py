...
import re
import os
from DirectoryWalker import DirectoryWalkerThread
import time
...
class fMain(wxFrame):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.btnAddRow = wxGenBitmapTextButton(ID=wxID_FMAINBTNADDROW,
              bitmap=wxBitmap('Images/Add.gif', wxBITMAP_TYPE_GIF), label='Add',
        ...
        self.btnDeleteRow = wxGenBitmapTextButton(ID=wxID_FMAINBTNDELETEROW,
              bitmap=wxBitmap('Images/Delete.gif', wxBITMAP_TYPE_GIF),
              label='Delete', name='btnDeleteRow', parent=self.pnbFunny,
              pos=wxPoint(208, 16), size=wxSize(76, 30), style=0)
    ...
    def __init__(self, parent):
        ...
        icon_file = os.path.join('Images', 'xbox-icon.ico')
